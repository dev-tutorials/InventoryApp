...
public class ItemCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView tvSerial = (TextView) view.findViewById(R.id.item_serial);
        // Extract properties from cursor
        String name = cursor.getString(cursor.getColumnIndex(ItemContract.ItemEntry.COLUMN_NAME));
        String serialNo = cursor.getString(cursor.getColumnIndex(ItemContract.ItemEntry.COLUMN_SERIAL_NO));
        // Populate fields with extracted properties
        tvName.setText(name);
        tvSerial.setText(serialNo);
    }
